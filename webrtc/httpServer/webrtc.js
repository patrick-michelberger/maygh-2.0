...
var initUI = function(){
	...
	var $txt_id = $("#txt_id").text(myid);
	var $txt_timeout = $('#txt_timeout').val(timeout);
	var $txt_window = $('#txt_window').val(WINDOW_SIZE);

	var $btn_set = $('#btn_set').click(function(){
	...
	var $btn_togger = $('#btn_togger').click(function(){
		should_stop_timer = !should_stop_timer;
	});
	
	var $btn_connect = $('#btn_connect').click(function(){
		initWebSocket();
	});
	// var $btn_peerConnect = $('<button>').text("initPeerConnection").click(function(){
	// 	initPeerConnection();
	// });
	var $btn_doCall = $('#btn_call').click(function(){
		doCall();
	});
	var $btn_sendPing = $('#btn_ping').click(function(){
		sendPing();
	});
	var $btn_sendReliableMessage = $('#btn_sendMessage').click(function(){
	...
	var $btn_sendReliableMessage10 = $('#btn_sendMessage10x').click(function(){
		var num_iter = 2;
		var iter = 0;
		var stats = [];
		var t0 = new Date().getTime();
	...
	var $txt_peermsg = $('#txt_peermsg').val("Hello World.");
	var $btn_send = $('#btn_send').click(function(){
		var msg = $txt_peermsg.val();
		sendPeerMsg(msg);
	});
};
